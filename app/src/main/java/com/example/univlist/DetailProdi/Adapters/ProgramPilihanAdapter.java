...
public class ProgramPilihanAdapter extends RecyclerView.Adapter<ProgramPilihanAdapter.ViewHolder> {

    private List<String> programPilihan;
    private Context context;

    public ProgramPilihanAdapter(List<String> programPilihan, Context context) {
