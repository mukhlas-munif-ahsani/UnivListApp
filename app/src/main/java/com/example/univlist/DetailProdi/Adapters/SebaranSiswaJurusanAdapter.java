...
public class SebaranSiswaJurusanAdapter extends RecyclerView.Adapter<SebaranSiswaJurusanAdapter.ViewHolder> {
    ...
    public SebaranSiswaJurusanAdapter(List<String> mSekolahJurusan, List<String> mTahunJurusan, List<String> mDiterimaJurusan, Context context) {
