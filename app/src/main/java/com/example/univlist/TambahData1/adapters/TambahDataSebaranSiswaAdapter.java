...
public class TambahDataSebaranSiswaAdapter extends RecyclerView.Adapter<TambahDataSebaranSiswaAdapter.ViewHolder> {
    ...
    public TambahDataSebaranSiswaAdapter(List<Integer> mSebaranTahun, List<Integer> mSebaranPendaftar, List<Integer> mSebaranDiterima, Context context) {
