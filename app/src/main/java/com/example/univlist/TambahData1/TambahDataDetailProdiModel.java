...
public class TambahDataDetailProdiModel {
    ...
    private static List<String> jurusan_pemilih;
    ...
    public TambahDataDetailProdiModel(){

    }

    public TambahDataDetailProdiModel(String documentId, String daerah, String daya_tampung, String kategori, String prodi, List<Integer> a_tahun, List<String> jurusan_pemilih, List<Integer> b_pendaftar, List<Integer> c_diterima, List<String> sekolah_jurusan, List<String> tahun_jurusan, List<String> diterima_jurusan) {
    ...
    public static List<String> getJurusan_pemilih() {
