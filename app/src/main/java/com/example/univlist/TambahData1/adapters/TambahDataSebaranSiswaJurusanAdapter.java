package com.example.univlist.TambahData1.adapters;
...
public class TambahDataSebaranSiswaJurusanAdapter extends RecyclerView.Adapter<TambahDataSebaranSiswaJurusanAdapter.ViewHolder> {
    ...
    public TambahDataSebaranSiswaJurusanAdapter(List<String> mSekolahJurusan, List<String> mTahunJurusan, List<String> mDiterimaJurusan, Context context) {
